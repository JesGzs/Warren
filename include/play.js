...
const { canModifyQueue, STAY_TIME } = require("../util/WarrenUtil");
const Discord = require("discord.js")
module.exports = {
  async play(song, message) {
    const { SOUNDCLOUD_CLIENT_ID } = require("../util/WarrenUtil");
    ...
    try {
      var playingMessage = await queue.textChannel.send(`<:youtube:789395251600687104> **Playing** **\`${song.title}\`**`);
    } catch (error) {
      console.error(error);
    }
    ...
    collector.on("collect", (reaction, user) => {
      ...
      switch (reaction.emoji.name) {
        case "⏭":
          ...
          .setDescription(`⏩ skipped the song [${user}]`)
          .setColor("#FD0000")
        ...
        case "⏯":
          ...
          if (queue.playing) {
            ...
            .setDescription(`⏸ paused the music [${user}]`)
            .setColor("#FD0000")
            ...
            .setDescription(`▶ resumed the music [${user}]`)
            .setColor("#FD0000")
        ...
        case "🔇":
          ...
          if (queue.volume <= 0) {
            ...
            .setDescription(`🔊 unmuted the music [${user}]`)
            .setColor("#FD0000")
            ...
            .setDescription(`🔇 muted the music [${user}]`)
            .setColor("#FD0000")
        ...
        case "🔉":
          ...
          .setDescription(`🔉 decreased the volume, the volume is now ${queue.volume}% [${user}]`)
          .setColor("#FD0000")
        ...
        case "🔊":
          ...
          .setDescription(`🔊 increased the volume, the volume is now ${queue.volume}% [${user}]`)
          .setColor(0x008FFF)
        ...
        case "⏹":
          ...
          .setDescription(`⏹ stopped the music [${user}]`)
          .setColor("#FD0000")

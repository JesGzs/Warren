...
module.exports = {
  ...
  async execute(message, args) {
    ...
    if (!permissions.has("CONNECT"))
      return message.reply("No puedo conectarme a un canal, me faltan permisos");
    ...
    if (mobileScRegex.test(url)) {
      ...
      return message.reply("Siguiendo la redirección de URL...").catch(console.error);
    }
    ...
    if (serverQueue) {
      ...
      .setDescription(`<a:listo:774769282067595274> \`${song.title}\` [${message.author}]`)
      .setColor(0x07EE03)
      return serverQueue.textChannel.send(embedadd).catch(console.error);
    }
